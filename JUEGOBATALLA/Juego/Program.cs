...
namespace JuegoNamespace
{
    ...
    {
        // Constructor sin parámetros que realiza las validaciones de entrada
        ...
        private string ObtenerNombreValido()
        {
            while (true)
            {
                Console.Write("Ingrese el nombre del nuevo personaje (obligatorio): ");
                ...
                Console.WriteLine("El nombre es obligatorio y debe contener solo letras. Inténtelo de nuevo.");
            }
        }
        ...
        private int ObtenerEnteroValido(string campo, int minimo, int maximo)
        {
            while (true)
            {
                ...
                Console.WriteLine($"Entrada inválida. {campo} debe ser un número entre {minimo} y {maximo}.");
            }
        }
    }
